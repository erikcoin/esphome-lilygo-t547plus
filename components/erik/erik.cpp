...
static const char *const TAG = "erik";
...
float Erik::get_setup_priority() const { return setup_priority::PROCESSOR; }
size_t Erik::get_buffer_length_() {
...
void HOT Erik::draw_absolute_pixel_internal(int x, int y, Color color) {
